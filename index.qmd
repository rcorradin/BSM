...
+-------------------------+---------------------------------------------------+------------------------------------------------------------+
| Linear models           | [Slides linear regression](slides/linear_reg.pdf) | [code_BSM2](code/code_BSM2.R)                              |
|                         |                                                   |                                                            |
|                         |                                                   | [informative_prior](code/informative_prior.stan)           |
|                         |                                                   |                                                            |
|                         |                                                   | [regular_gaussian_prior](code/regular_gaussian_prior.stan) |
|                         |                                                   |                                                            |
