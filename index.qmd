...
+---------------------------------+-------------------------------------------+--------------------------------------------------------------------------+----------------+
| Computational methods           | [Notes computation](slides/comp.pdf)      | [BSM2.R](code/BSM2.R)                                                    |                |
|                                 |                                           |                                                                          |                |
|                                 |                                           | [Notes ](slides/comp.pdf)[bernoulli_beta.stan](code/bernoulli_beta.stan) |                |
|                                 |                                           |                                                                          |                |
|                                 |                                           | [normal_normal_gamma.stan](code/normal_normal_gamma.stan)                |                |
|                                 |                                           |                                                                          |                |
|                                 |                                           | [poi.stan](slides/poi.stan)                                              |                |
+---------------------------------+-------------------------------------------+--------------------------------------------------------------------------+----------------+
| Regression models               | [Notes regression](slides/regression.pdf) |                                                                          |                |
+---------------------------------+-------------------------------------------+--------------------------------------------------------------------------+----------------+
