...
|                         |                                                   |                                                            |                                              |
|                         |                                                   | [informative_prior](code/informative_prior.stan)           | [frogs.csv](cs_files/frogs.csv)              |
|                         |                                                   |                                                            |                                              |
...
+-------------------------+---------------------------------------------------+------------------------------------------------------------+----------------------------------------------+
| GLMs                    | [Slides GLMs](slides/GLM.pdf)                     | [code_BSM3](code/code_BSM3.R)                              |                                              |
|                         |                                                   |                                                            |                                              |
|                         |                                                   | [poisson_glm](code/poisson_glm.stan)                       |                                              |
|                         |                                                   |                                                            |                                              |
|                         |                                                   | [gamma_glm](code/gamma_glm.stan)                           |                                              |
+-------------------------+---------------------------------------------------+------------------------------------------------------------+----------------------------------------------+
