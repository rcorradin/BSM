...
+-------------------------+---------------------------------------------------+-------------------------------------------------------------+----------------------------------------------+
| Model improvement       | [Slides improvement](slides/improvement.pdf)      | [code_BSM4](code/code_BSM4.R)                               |                                              |
|                         |                                                   |                                                             |                                              |
|                         |                                                   | [logistic_model](code/logistic_model.stan)                  |                                              |
|                         |                                                   |                                                             |                                              |
|                         |                                                   | [regression_model](code/regression_model.stan)              |                                              |
|                         |                                                   |                                                             |                                              |
|                         |                                                   | [regression_model_hyper](code/regression_model_hyper.stan)  |                                              |
|                         |                                                   |                                                             |                                              |
|                         |                                                   | [regression_SSVS_model](code/regression_SSVS_model.stan)    |                                              |
|                         |                                                   |                                                             |                                              |
|                         |                                                   | [skeleton](code/skeleton4.R)                                |                                              |
+-------------------------+---------------------------------------------------+-------------------------------------------------------------+----------------------------------------------+
| Clustering              | TBD                                               |                                                             |                                              |
+-------------------------+---------------------------------------------------+-------------------------------------------------------------+----------------------------------------------+
